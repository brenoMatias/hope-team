        ...
        <div> 
            <div className="about"> 
                <div className="about-main">
                    ...
                    <h1 className='h-about'> Dudu e a Hope Team</h1>
                    <div className='p-box'> 
                    ...
                    <p className='p-about'>
                    Em 2012 a Hope Team foi fundada em Ipatinga/MG com intuito de transformar a vida de pessoas que buscam uma paixão esportiva. A Hope serve a diversos lutadores amadores e também profissionais. Aqueles também que buscam apenas por uma atividade física divertida e de resultados também são muito bem vindos.
                    </p>
                    <p className='p-about'>
                    O boxe trás consigo diversos beníficios corporais e mentais. A Hope oferece aulas de boxe em turmas e personal trainer para homens e mulheres de todas as idades. Oferecemos aulas experimentais para aqueles que querem conhecer o treino. Venha mudar seu estilo de vida!
                    </p>
