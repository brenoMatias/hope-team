            ...
            <div className='about'> 
                ...
                <h1 className='habout'> Dudu e a Hope Team</h1>
                   ...
                   target='_blank' rel="noreferrer">
                    ...
                    <p className='pabout'>&nbsp;&nbsp;&nbsp;&nbsp;Com uma carreira de muitas vitórias, Dudu sentiu a necessidade de retribuir a oportunidade que lhe foi dada na infância. Seguindo os pensamentos do projeto social que o acolheu, o boxeador criou o projeto Dudu Nova Geração para atender crianças carentes. </p>
                    <p className='pabout'> 
